...
var bg21 = require('../../../../assets/images/background/bg-2-1.jpg');
var testimonial = require('../../../../assets/images/d2-testimonial.png');
const About2SectionTestimonial = (props) => {	  	
    return(
	<>
	{/*<!-- TESTIMONIAL SECTION START --> */}
	<div className="section-full  p-t80 p-b80 testimonial-2-outer bg-cover bg-center bg-image-moving overflow-hidden" style={{backgroundImage:`url(${bg21})`}}>
...
export default About2SectionTestimonial;