...
const About2SectionHowItWork = (props) => {	  	
    return(
	<>
					...
					<div className="row justify-content-center d-flex how-it-drone3">
						...
						<div className="col-lg-4 col-md-12 m-b30 how-it-drone3-left">
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper right ">
									...
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-power-supply"></i></span>
									</div>
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper right">
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-drone"></i></span>
									</div>
									<div className="icon-content">
										<div className="d-icon-box-title title-style-2 site-text-secondry">
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper right">
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-panorama"></i></span>
									</div>
									<div className="icon-content">
										<div className="d-icon-box-title title-style-2 site-text-secondry">
						...
						<div className="col-lg-4 col-md-12 m-b30 how-it-drone3-right">
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper left">
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-drone-6"></i></span>
									</div>
									<div className="icon-content">
										<div className="d-icon-box-title title-style-2 site-text-secondry">
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper left">
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-remote-control"></i></span>
									</div>
									<div className="icon-content">
										<div className="d-icon-box-title title-style-2 site-text-secondry">
							...
							<div className="wt-box d-icon-box-two m-b40">
								<div className="wt-icon-box-wraper left">
									<div className="icon-md inline-icon">
										<span className="icon-cell site-text-secondry"><i className="flaticon-drone-2"></i></span>
									</div>
									<div className="icon-content">
										<div className="d-icon-box-title title-style-2 site-text-secondry">
...
export default About2SectionHowItWork;