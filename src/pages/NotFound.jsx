	 ...
	 <div className="page-wraper">  
       {/* <!-- CONTENT START --> */}
        <div className="page-content">
            ...
            {/* <!-- Error SECTION START --> */}
            <div className="error-full-page bg-cover overlay-wraper bg-image-moving" style={{backgroundImage:`url(${bg2})`}}>
                    ...
                    <div className="error-full-page-inner">
                    	<div className="error-full-page-inner-info">
								...
								<Link to="/" className="site-button site-btn-effect">GO TO HOME</Link>
                        </div>
                    </div>
            </div>   
           {/* <!-- Error  SECTION END --> */}
