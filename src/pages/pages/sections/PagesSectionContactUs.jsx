...
const PagesSectionContactUs = (props) => {	
	...
	{/*<!-- CONTACT FORM --> */}
	<div className="section-full  p-t80 p-b50 bg-cover" style={{backgroundImage:'url(/assets/images/background/bg-7.jpg)'}}>   
		<div className="section-content">
			<div className="container">
				<div className="contact-one">
					...
					<div className="row  d-flex justify-content-center flex-wrap">
						...
						<div className="col-lg-6 col-md-6 m-b30">
							<div className="contact-info">
								<div className="contact-info-inner">
									...
									<div className="contact-info-section" style={{backgroundImage:'url(/assets/images/background/bg-map2.png)'}}>  
						...
						<div className="col-lg-6 col-md-6 m-b30">
							...
							<form  className="cons-contact-form" method="post" onSubmit={handleSubmit}> {/*onSubmit={handleSubmit}*/}
								{/*<!-- TITLE START --> */}
								<div className="section-head left wt-small-separator-outer">
									<h3>Get In Touch</h3>
								</div>                                                                                
