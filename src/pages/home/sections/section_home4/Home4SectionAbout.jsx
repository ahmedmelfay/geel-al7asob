...
var untitled1 = require('../../../../assets/images/about-drone/Untitled-1.png');
const Home4SectionAbout = (props) => {	  	
    return(
	<>
					...
					<div className="row justify-content-center d-flex">					
						<div className="col-lg-6 col-md-12 m-b30">
							<div className="about-drone-one">
								<div className="about-drone-one-media"><img src={untitled1} alt=""  className="slide-top" /></div>
								<div className="about-drone-one-info"><span className="outline-title">HD 4K</span><strong>Resolution!</strong></div>
							</div>
						</div>  											  
						<div className="col-lg-6 col-md-12 m-b30">
							...
							<Link to="/about2"  className="site-button site-btn-effect">Read More</Link>
							</div>                                                                
						</div>						
					</div>
				</div>
...
export default Home4SectionAbout;