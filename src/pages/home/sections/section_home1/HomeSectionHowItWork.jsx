...
var drone1 = require('../../../../assets/images/how-it-work/drone-1.png');
const HomeSectionHowItWork = (props) => {	  	
    return(
	<>
	{/* <!-- HOW IT WORK SECTION START --> */}
		<div className="section-full welcome-section-outer">
			<div className="how-it-work-section-one bg-white p-tb80">
				<div className="container">				
					...
					<div className="section-content"> 
						<div className="row justify-content-center d-flex">
							...
							<div className="col-lg-8 col-md-12 m-b30 how-it-drone-outer">
								<div className="how-it-drone">
									<div className="how-it-drone-media"><img src={drone1} alt="" className="wave-effects" /></div>
								   
									<div className="how-it-drone-info"><span>We Deliver First Class Videos & Photos</span></div>
								</div>
							</div>  
								...
								<div className="wt-box d-icon-box-one bg-white shadow card1">
									...
									<div className="wt-icon-box-wraper m-b40">
										<div className="icon-xl inline-icon">
											<span className="icon-cell site-text-primary"><i className="flaticon-drone-6"></i></span>
										</div>
									</div> 
									...
									<div className="d-icon-box-content">
										...
										<Link to="/about"  className="site-button-link site-text-primary">Read More</Link>
									</div>																			
								</div>
							</div>
							...
							<div className="col-lg-4 col-md-6 m-b30">
								<div className="wt-box d-icon-box-one bg-white shadow card1">
									...
									<div className="wt-icon-box-wraper m-b40">
										<div className="icon-xl inline-icon">
											<span className="icon-cell site-text-primary"><i className="flaticon-power-supply"></i></span>
										</div>
									</div> 
							...
							<div className="col-lg-4 col-md-6 m-b30">
								<div className="wt-box d-icon-box-one bg-white shadow card1">
									...
									<div className="wt-icon-box-wraper m-b40">
										<div className="icon-xl inline-icon">
											<span className="icon-cell site-text-primary"><i className="flaticon-remote-control"></i></span>
										</div>
									</div> 
...
export default HomeSectionHowItWork;