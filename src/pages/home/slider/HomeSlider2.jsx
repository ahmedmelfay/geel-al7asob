                    ...
                    <div id="webmax-three" className="rev_slider fullscreenbanner" style={{display:'none'}} data-version="5.4.3.1">
                        <ul>	
                            ...
                            data-description="">
								...
								<img src={slide1}  alt=""  data-lazyload={slide1} data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Power1.easeOut" data-scalestart="110" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" className="rev-slidebg" data-no-retina />
                                ...
                                <div className="tp-caption   tp-resizeme change-img-slide1" 
                                ...
                                style={{zIndex: 11, whiteSpace: 'normal', fontWeight:700, color:'#fff', borderWidth:'0px', fontFamily: "'Rajdhani','sans-serif'", textTransform:'uppercase'}}>
								<div className="site-text-primary"> From every angle</div></div>                                
                                ...
                                style={{zIndex:11, fontWeight:500, color:'#d3d3d3', borderWidth:'0px', fontFamily: "'Muli','sans-serif'"}}>
                                  There are many variations of passages of lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.
                                </div>
                            
                                {/*<!-- LAYER NR. 5 [ for botton ] -->*/}
                                <div className="tp-caption tp-resizeme rev-btn" 	
                                ...
                                <div className="tp-caption rev-btn  tp-resizeme slider-block" 
                                    ...
                                    style={{zIndex: 8}}><div className="rs-wave"  data-speed="3" data-angle="0" data-radius="10px"></div></div>                                   
                            ...
                            data-description="">
								...
								{/*<!-- LAYER NR. 1 Drone Img -->*/}
                                <div className="tp-caption   tp-resizeme   change-img-slide2" 
                                ...
                                style={{zIndex:11, whiteSpace:'normal', fontWeight:700, color:'#fff', borderWidth:'0px', fontFamily: "'Rajdhani','sans-serif'"}}>Gives You the</div>
                                ...
                                style={{zIndex: 11, whiteSpace: 'normal', fontWeight:700, color:'#fff', borderWidth:'0px', fontFamily: "'Rajdhani','sans-serif'",  textTransform:'uppercase'}}><div className="site-text-primary">Visible Difference</div></div>                                
                            ...
                            data-description="">
								...
								<img src={slide3}  alt=""  data-lazyload={slide3} data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Power1.easeOut" data-scalestart="110" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" className="rev-slidebg" data-no-retina />
								...
								{/*<!-- LAYER NR. 1 Drone Img -->*/}
                                <div className="tp-caption   tp-resizeme change-img-slide3" 
                                ...
                                style={{zIndex:11, whiteSpace:'normal', fontWeight:700, color:'#fff', borderWidth:'0px', fontFamily: "'Rajdhani','sans-serif'"}}>We Capture the</div>
                                ...
                                style={{zIndex:11, whiteSpace: 'normal', fontWeight:700, color:'#fff', borderWidth:'0px', fontFamily: "'Rajdhani','sans-serif'",  textTransform:'uppercase'}}><div className="site-text-primary">Precious Moments </div></div>                                
