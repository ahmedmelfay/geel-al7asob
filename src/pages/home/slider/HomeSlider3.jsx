...
var slide1 = require('../../../assets/images/main-slider/slider2/slide1.jpg');
var d1 = require('../../../assets/images/main-slider/slider2/d-1.png');
var slide2 = require('../../../assets/images/main-slider/slider2/slide2.jpg');
var d2 = require('../../../assets/images/main-slider/slider2/d-2.png');
var slide3 = require('../../../assets/images/main-slider/slider2/slide3.jpg');
var d3 = require('../../../assets/images/main-slider/slider2/d-3.png');
const Slider3 = () => {
    return(
	<>		 
        	{/* <!-- SLIDER START --> */} 
                    ...
                    <div id="webmax-two" className="rev_slider fullscreenbanner" style={{display:'none'}} data-version="5.4.3.1">
                        <ul>	
                            ...
                            data-description="">
                                ...
                                <div className="tp-caption   tp-resizeme home-3-change-img-slide1 " 
                                ...
                                style={{zIndex:11, whiteSpace: 'normal', fontWeight:700, color:'#1a1a1a', borderWidth:'0px', fontFamily:"'Rajdhani', 'sans-serif'"}}><div className="slider-block-sky">Ultraportable Drone for the best Video</div></div>
                                ...
                                style={{zIndex: 11, fontWeight: 500, color:'#1a1a1a', borderWidth:'0px', fontFamily:"'Muli', 'sans-serif'"}}>
                                ...
                                style={{zIndex:9}}>
                                     <div className="mfp-video rev-slider-play2">
                                        <span className="ripple-cirlcle2"></span>
                                    </div>   
                                </div> 
                            ...
                            data-description="">
								...
								{/* <!-- LAYER NR. 1 Drone Img --> */}
                                <div className="tp-caption   tp-resizeme home-3-change-img-slide2 " 
                                ...
                                style={{zIndex: 11, whiteSpace: 'normal', fontWeight:700, color:'#1a1a1a', borderWidth:'0px', fontFamily:"'Rajdhani', 'sans-serif'"}}><div className="slider-block-sky">Gives you the Visible Difference</div></div>
                            ...
                            data-description="">
                                ...
                                style={{zIndex: 11, whiteSpace: 'normal', fontWeight:700, color:'#1a1a1a', borderWidth:'0px', fontFamily:"'Rajdhani', 'sans-serif'"}}><div className="slider-block-sky">We Capture the Precious Moments</div></div>
