var pic1 = require('../assets/images/service/large-slider/pic1.jpg');
var pic2 = require('../assets/images/service/large-slider/pic2.jpg');
var pic3 = require('../assets/images/service/large-slider/pic3.jpg');
var pic4 = require('../assets/images/service/large-slider/pic4.jpg');
const ImagesLargeSlider = [
  {
    id: 1,
    src: pic1,
    alt: "Image 1",
    title: "How to Fly a Quadcopter 1",
    description:
